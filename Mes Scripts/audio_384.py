...
def encode_file(src_path, dst_path):
    cmd = [
        ...
        # AC3 — préserve automatiquement 5.1 si présent
        "-c:a", "ac3", "-b:a", BITRATE,
    ...
    print(f"\n🔊 Encodage audio 384k → {os.path.basename(dst_path)}")
    print(" ".join(cmd), "\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Conversion audio AC3 384k (préserve 5.1)")
